...
void setup() {
  ...
  server.on("/setOn", HTTP_GET, [](AsyncWebServerRequest *request){
    ...
    Serial.println("on request set: " + paramOn.time + ", " + paramOn.weekdays);
    request->send(SPIFFS, "/index.html", "text/html");
  });
  ...
  server.on("/setOff", HTTP_GET, [](AsyncWebServerRequest *request){
    ...
    Serial.println("off request set: " + paramOff.time + ", " + paramOff.weekdays);
    request->send(SPIFFS, "/index.html", "text/html");
  });
  ...
  server.on("/setPlaceholder", HTTP_GET, [](AsyncWebServerRequest *request){
    ...
    Serial.println("placeholder request set: " + paramPlaceholder.time + ", " + paramPlaceholder.weekdays);
    request->send(SPIFFS, "/index.html", "text/html");
  });
